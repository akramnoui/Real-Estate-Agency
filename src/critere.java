...
public class critere {
    public List<Bien> liste_des_biens_filtres = new ArrayList<>(); //liste des biens de l'agence


    public void recherche_critere(Wilaya wilaya) {
        Bien bien = null;
        int cpt = 0;
    ...
    public void recherche_critere(TypeDeTransaction trans) {
        Bien bien = null;
        int cpt = 0;
    ...
    public void recherche_critere(Bien bien) {
        int cpt = 0;
        for(Bien ele: ImmoESI.liste_des_biens){
    ...
    public void recherche_critere(criterePrix o) {
        Bien bien = null;
        int cpt = 0;
        for (Bien ele : ImmoESI.liste_des_biens) {
        ...
        public void recherche_critere(critereSuperficie o) {
            Bien bien = null;
            int cpt = 0;
            for (Bien ele : ImmoESI.liste_des_biens) {
